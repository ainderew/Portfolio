...
const MySetup: React.FC = () => {
	return (
		<div className='setup h-full'>
			<WebNav />
			<div className='h-[100vh]  py-[10rem] w-full'>
				<div className='w-[80%] xl:w-[70%] m-auto flex flex-col justify-center items-center gap-6'>
					...
					<div className='w-full flex justify-center gap-2'>
						...
						<button className='bg-[#008cff30] rounded-3xl px-4 h-11 text-[#135981] duration-500 group flex items-center justify-center gap-[0.3rem]'>
							Video installation
							<svg
								width='24'
								height='24'
					...
					<CopyArea command='export PATH="/opt/homebrew/bin:$PATH" >> ~/.zshrc' />
