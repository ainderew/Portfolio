  ...
  return (
    <div className="w-[90%] xl:w-[70%] max-w-[1344px] h-auto mx-auto">
      <div className="w-full h-screen relative py-[10vh] mx-auto flex flex-col gap-2 items-center justify-center xl:items-start xl:justify-center xl:py-0 ">
        ...
        <motion.h1
          variants={fadeIn('up')}
          className="text-3xl xl:text-7xl font-semibold"
        >
          Andrew Pinon
        </motion.h1>
        <motion.h2
        ...
        >
          ...
          Currently I currenty work at Theoria Medical but I&apos;m still open
          to projects. Let&apos;s create your own digital experience!
        </motion.p>
