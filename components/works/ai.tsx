    ...
    >
      ...
      >
        ...
        <div className="content-container flex flex-col gap-4 ">
          <h2 className="project-heading text-7xl font-bold mb-10">Workdash</h2>
          <p className="role-heading text-3xl font-medium">
            FullStack Developer
          </p>
          <p className="project-description text-2xl break-words ">
            Video, Audio, and Messaging application with a twist implemented in
            a 2d environment to provide a more interactive fashion.
          </p>
          ...
          <ul className="mt-10 flex flex-col gap-2">
            ...
            <li className="">
              <a href="https://workdash.site" className="flex gap-4 text-xl">
                <Image src={web} width={20} height={20} />
                https://www.workdash.site
              </a>
            </li>
          </ul>
        </div>
